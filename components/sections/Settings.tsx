...
function buildSampleData() {
  ...
  const beefChecklist = [
    ...
    { section: 'Animal Welfare', item: 'Veterinary Health Plan (VHP) in place and reviewed annually', status: 'Yes', notes: 'VHP with Henley Vets reviewed Feb 2026' },
    ...
    { section: 'Animal ID & Movement', item: 'CPH number displayed at farm entrance', status: 'Yes', notes: 'CPH 37/804/0022' },
